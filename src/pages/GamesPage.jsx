...
function GamesPage() {
    ...
    try {
      ...
      if (user) {
        ...
        if (scores) {
          ...
          const total = (scores.games_played_tetris || 0) + 
  ...
  const getDifficultyColor = (difficulty) => {
    switch(difficulty) {
      case 'Easy': return '#89A8C7';
      case 'Medium': return '#FFD700';
      case 'Hard': return '#FFA0A0';
      default: return '#50B6D1';
    }
  };
        ...
        <div style={{ 
          ...
          <section style={{ width: '100%', maxWidth: '1200px' }}>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#50B6D1' }}>
                    {games.length + casinoGames.length}
                  </div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 'bold' }}>Total Games</div>
                </div>
                <div style={{
                  background: 'rgba(255,255,255,0.95)',
                  border: '3px solid #000',
                  ...
                  <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#FFA0A0' }}>
                    {user ? (loading ? '...' : totalGamesPlayed) : '?'}
                  </div>
                  <div style={{ fontSize: '0.9rem', fontWeight: 'bold' }}>Games Played</div>
                </div>
                <div style={{
                  background: 'rgba(255,255,255,0.95)',
                  border: '3px solid #000',
                  ...
                  <div style={{ fontSize: '0.9rem', fontWeight: 'bold' }}>Player Status</div>
                </div>
              </div>
            ...
            <div className="windowContent">
              ...
              <h2 style={{ fontSize: '2rem', marginBottom: '20px', color: '#03274B', display: 'flex', alignItems: 'center', gap: '10px' }}>
                🎮 CLASSIC ARCADE
              </h2>
                  ...
                  >
                    <div 
                      ...
                      style={{ 
                        padding: '0',
                        border: '4px solid #000', 
                        boxShadow: hoveredGame === game.name ? '12px 12px 0px #000' : '6px 6px 0px #000',
                        background: '#fff',
                        cursor: 'pointer',
                        textAlign: 'center',
                        transition: 'all 0.3s ease',
                        transform: hoveredGame === game.name ? 'translateY(-8px) scale(1.02)' : 'translateY(0) scale(1)',
                      ...
                      <div style={{
                        ...
                        <img 
                          ...
                          style={{
                            ...
                            transform: hoveredGame === game.name ? 'scale(1.1) rotate(5deg)' : 'scale(1)'
                          }}
                        />
                      </div>
                      ...
                      <div style={{ padding: '20px' }}>
                        ...
                        <div style={{
                          ...
                          <div style={{ textAlign: 'center' }}>
                            <div style={{ fontSize: '0.75rem', opacity: 0.7 }}>GENRE</div>
                            <div style={{ fontSize: '0.85rem', fontWeight: 'bold' }}>{game.genre}</div>
                          </div>
                          <div style={{ textAlign: 'center' }}>
                            <div style={{ fontSize: '0.75rem', opacity: 0.7 }}>PLAYERS</div>
                            <div style={{ fontSize: '0.85rem', fontWeight: 'bold' }}>{game.players}</div>
                          </div>
                        </div>
                        ...
                        <div style={{
                          marginTop: '20px',
                          padding: '15px',
                          background: hoveredGame === game.name ? '#000' : '#03274B',
                          color: '#fff',
                          fontWeight: 'bold',
                          fontSize: '1.1rem',
                          border: '3px solid #000',
                          ...
                          {hoveredGame === game.name ? '▶ PLAY NOW!' : 'CLICK TO PLAY'}
                        </div>
                      </div>
                    </div>
                  </Link>
              ...
              <h2 style={{ fontSize: '2rem', marginTop: '50px', marginBottom: '20px', color: '#ff0000', display: 'flex', alignItems: 'center', gap: '10px' }}>
                🎰 CASINO GAMES
              </h2>
                      ...
                      <div style={{ padding: '20px' }}>
                        ...
                        {user && (
                          <div style={{
                            ...
                            <div style={{ fontSize: '0.8rem', fontWeight: 'bold', marginBottom: '5px', color: '#000' }}>
                              💰 HIGHEST CREDITS
                            </div>
                            <div style={{ fontSize: '1.8rem', fontWeight: 'bold', color: '#000' }}>
                              {loading ? '...' : (highScores[game.scoreKey] || 0)}
                        ...
                        <div style={{
                          marginTop: '20px',
                          padding: '15px',
                          background: hoveredGame === game.name ? '#000' : game.color,
              ...
              <div className="separate" style={{ marginTop: '30px' }}>
                <h2 style={{ fontSize: '1.8rem', marginBottom: '20px', color: '#03274B', display: 'flex', alignItems: 'center', gap: '10px' }}>
                  🎮 ARCADE TIPS & INFO
                </h2>
                <div style={{
                  display: 'grid',
                  ...
                  <div className="post" style={{ 
                    maxHeight: 'none',
                    background: 'linear-gradient(135deg, #50B6D1 0%, #89A8C7 100%)',
                    border: '3px solid #000',
                    color: '#000'
                  }}>
                    <h3 style={{ fontSize: '1.3rem', marginBottom: '10px' }}>🎯 Controls</h3>
                    <p style={{ fontSize: '0.95rem', lineHeight: '1.6' }}>
                      All games work on desktop and mobile. Use arrow keys on desktop, touch controls on mobile devices.
                    </p>
                  </div>
                  <div className="post" style={{ 
                    maxHeight: 'none',
                    background: 'linear-gradient(135deg, #FFA0A0 0%, #FFD3B6 100%)',
                    border: '3px solid #000',
                    color: '#000'
                  }}>
                    <h3 style={{ fontSize: '1.3rem', marginBottom: '10px' }}>💾 Saves</h3>
                    <p style={{ fontSize: '0.95rem', lineHeight: '1.6' }}>
                      {user ? 'Your high scores are saved to your account!' : 'Login to save your high scores!'}
                    </p>
                  </div>
                  <div className="post" style={{ 
                    maxHeight: 'none',
                    ...
                    <h3 style={{ fontSize: '1.3rem', marginBottom: '10px' }}>🏆 Challenge</h3>
                    <p style={{ fontSize: '0.95rem', lineHeight: '1.6' }}>
                      Beat your personal best! Games get harder as you score more points.
                    </p>
                  </div>
                </div>
              </div>
