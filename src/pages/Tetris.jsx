...
function Tetris() {
  ...
  }, [currentPiece, position, board, gameStarted, gameOver, score, highScore, level, lines]);
        ...
        <div style={{ 
          ...
          <section style={{ width: '100%', maxWidth: '900px' }}>
            ...
            <div className="windowContent" style={{ textAlign: 'center' }}>
              <h1 style={{ marginBottom: '20px', fontSize: '2rem' }}>🎮 RETRO TETRIS</h1>
              ...
              {gameOver && (
                <div>
                  <div style={{
                    ...
                    <p style={{ fontSize: '1rem', margin: '5px 0 0 0' }}>Lines: {lines}</p>
                  </div>
                  <br />
                  <button 
                    onClick={startGame}
              ...
              <div className="separate" style={{ marginTop: '30px', textAlign: 'left' }}>
                ...
                <div className="post" style={{ maxHeight: 'none' }}>
                  ...
                  <p style={{ fontSize: '1.1rem', marginTop: '15px', color: '#50B6D1' }}>
                    <b>💡 Tip:</b> Clear multiple lines at once for bonus points!
                  </p>
                </div>
              </div>
            </div>
