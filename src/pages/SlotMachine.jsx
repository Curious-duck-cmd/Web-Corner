      ...
      if (spinCount >= maxSpins) {
        ...
        setMessage(
          getWinMessage(winAmount) +
            (winAmount > 0 ? ` Won: ${winAmount} credits!` : ""),
        );
        setSpinning(false);
      }
    }, 100);
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: "bold",
                    cursor:
                      spinning || credits < bet ? "not-allowed" : "pointer",
              ...
              <div className="separate" style={{ textAlign: "left" }}>
                ...
                <div className="post" style={{ maxHeight: "none" }}>
                  <div style={{ fontSize: "1rem", lineHeight: "1.8" }}>
                    <p>
                      <b>7️⃣ 7️⃣ 7️⃣</b> → Bet × 50 (JACKPOT!)
                    </p>
                    <p>
                      <b>💎 💎 💎</b> → Bet × 25
                    </p>
